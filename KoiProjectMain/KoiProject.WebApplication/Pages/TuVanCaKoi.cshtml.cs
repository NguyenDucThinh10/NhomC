...
namespace KoiProject.WebApplication.Pages
{
    ...
    {
        private readonly string _connectionString = "Data Source=LAPTOP-PBFDCTTE;Initial Catalog=FengShuiKoiDB1;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
